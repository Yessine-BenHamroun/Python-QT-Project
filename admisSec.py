...
# Form implementation generated from reading ui file 'admisSec.ui'
#
...
class Ui_Dialog(object):
    ...
    def admSec(self):
        ...
        for etudiant in self.inst.admiSec(self.comboBox.currentText()):
            etu=[]
...
"")
        ...
        self.label_10.setGeometry(QtCore.QRect(370, 20, 411, 51))
        font = QtGui.QFont()
...
"padding-bottom:7px;")
        ...
        self.pushButton.clicked.connect(self.admSec)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.pushButton.setText(_translate("Dialog", "Rechercher"))
        self.label_10.setText(_translate("Dialog", "Etudiants Admis d\'une section"))
