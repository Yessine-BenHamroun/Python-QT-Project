...
# Form implementation generated from reading ui file 'rechSecMat.ui'
#
...
class Ui_Dialog(object):
    ...
    def affSecMat(self):
        ...
        for matiere in self.inst.rechSecM(self.comboBox.currentText()):
            mat=[]
    ...
    def setupUi(self, Dialog):
        ...
        self.label_10.setGeometry(QtCore.QRect(400, 10, 301, 51))
        font = QtGui.QFont()
...
"border:none;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(420, 100, 150, 41))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(87)
...
"padding-bottom:7px;")
        ...
        self.comboBox.setGeometry(QtCore.QRect(140, 100, 261, 35))
        font = QtGui.QFont()
...
"padding-bottom:7px;")
        ...
        self.pushButton.clicked.connect(self.affSecMat)
