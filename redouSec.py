...
# Form implementation generated from reading ui file 'redouSec.ui'
#
...
class Ui_Dialog(object):
    ...
    def redoSec(self):
        ...
        for etudiant in self.inst.redSec(self.comboBox.currentText()):
            etu=[]
    ...
    def setupUi(self, Dialog):
        ...
        self.tableView.setGeometry(QtCore.QRect(20, 190, 821, 391))
...
"border:none;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(460, 114, 150, 41))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(87)
...
"")
        ...
        self.label_10.setGeometry(QtCore.QRect(320, 20, 491, 51))
        font = QtGui.QFont()
...
"padding-bottom:7px;")
        ...
        self.comboBox.setGeometry(QtCore.QRect(140, 120, 291, 35))
        font = QtGui.QFont()
...
"padding-bottom:7px;")
        ...
        self.pushButton.clicked.connect(self.redoSec)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.pushButton.setText(_translate("Dialog", "Rechercher"))
        self.label_10.setText(_translate("Dialog", "Etudiants Redoublants d\'une section"))
