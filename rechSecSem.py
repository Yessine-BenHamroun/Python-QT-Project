...
# Form implementation generated from reading ui file 'rechSecSem.ui'
#
...
class Ui_Dialog(object):
    ...
    def affSecSem(self):
        ...
        for matiere in self.inst.rechSecSem(self.comboBox.currentText(),self.comboBox_2.currentText()):
            mat=[]
    ...
    def setupUi(self, Dialog):
        ...
        self.comboBox.setGeometry(QtCore.QRect(130, 100, 261, 35))
        font = QtGui.QFont()
...
"border:none;")
        ...
        self.label_10.setGeometry(QtCore.QRect(330, 10, 471, 51))
        font = QtGui.QFont()
...
"padding-bottom:7px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(820, 100, 150, 41))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(87)
...
"")
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(550, 100, 250, 35))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
...
"padding-bottom:7px;")
        ...
        self.label_2.setGeometry(QtCore.QRect(430, 100, 121, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"padding-bottom:7px;")
        ...
        self.pushButton.clicked.connect(self.affSecSem)
