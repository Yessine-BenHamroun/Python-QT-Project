...
class Ui_Dialog(object):
    ...
    def affBult(self):
        ...
        for matiere in self.inst.rechInsNote(self.lineEdit.text()):
            mat=[]
        ...
        gen.append("")
        gen.append("")
        gen.append("Moyenne General :"+"{:.3f}".format(self.inst.moyGen(self.lineEdit.text())))
        alter.append(gen)
...
"padding-bottom:7px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(550, 94, 150, 41))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(87)
...
"")
        ...
        self.label_10.setGeometry(QtCore.QRect(360, 10, 401, 51))
        font = QtGui.QFont()
...
"border:none;")
        ...
        self.pushButton.clicked.connect(self.affBult)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(_translate("Dialog", "Bulletin de note d\'un étudiant"))
